...
<Library LVVersion="19008000">
	...
	<Item Name="Messages for This Actor" Type="Folder">
		<Item Name="Read Displayed Seconds on Timing Msg.lvclass" Type="LVClass" URL="../Configuration Database Messages/Read Displayed Seconds on Timing Msg/Read Displayed Seconds on Timing Msg.lvclass"/>
		<Item Name="Update Displayed Seconds on Timing Msg.lvclass" Type="LVClass" URL="../Configuration Database Messages/Update Displayed Seconds on Timing Msg/Update Displayed Seconds on Timing Msg.lvclass"/>
	</Item>
	<Item Name="Configuration Database.lvclass" Type="LVClass" URL="../Configuration Database Actor/Configuration Database.lvclass"/>
</Library>
