...
<Library LVVersion="19008000">
	...
	<Item Name="Messages for this Actor" Type="Folder">
		<Item Name="Write Card Read Msg.lvclass" Type="LVClass" URL="../Sim Display Console Actor Messages/Write Card Read Msg/Write Card Read Msg.lvclass"/>
		<Item Name="Write Message Msg.lvclass" Type="LVClass" URL="../Sim Display Console Actor Messages/Write Message Msg/Write Message Msg.lvclass"/>
		<Item Name="Write Transaction Msg.lvclass" Type="LVClass" URL="../Sim Display Console Actor Messages/Write Transaction Msg/Write Transaction Msg.lvclass"/>
	</Item>
	<Item Name="Sim Display Console Actor.lvclass" Type="LVClass" URL="../ATM Controller/Sim Display Console Actor.lvclass"/>
</Library>
